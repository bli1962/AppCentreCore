...
{
    [Keyless]
    [Table("M_BK_FX_LENDING_LMT_INTEG", Schema = "EUC")]
    public partial class MBkFxLendingLmtInteg
    {
        ...
        [Column("HO_TOT_LIMIT", TypeName = "decimal(18, 3)")]
        public decimal? HoTotLimit { get; set; }
        ...
        [Column("BR_TOT_LIMIT", TypeName = "decimal(18, 3)")]
        public decimal? BrTotLimit { get; set; }
        ...
        [Column("TOT_BAL", TypeName = "decimal(18, 3)")]
        ...
        [Column("SUBLIMIT_HO_TOT", TypeName = "decimal(18, 3)")]
        public decimal? SublimitHoTot { get; set; }
        ...
        [Column("SUBLIMIT_BR_TOT", TypeName = "decimal(18, 3)")]
        public decimal? SublimitBrTot { get; set; }
        ...
        [Column("SUBLIMIT_TOT_BAL", TypeName = "decimal(18, 3)")]
        public decimal? SublimitTotBal { get; set; }
        ...
        [Column("TOT_COMMENT")]
        [StringLength(9)]
        public string TotComment { get; set; }
        [Column("SHRT_COMMENT")]
        [StringLength(9)]
