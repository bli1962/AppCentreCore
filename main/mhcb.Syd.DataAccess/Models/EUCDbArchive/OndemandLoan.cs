...
{
    [Keyless]
    [Table("ONDEMAND_LOAN", Schema = "EUC_ONDM")]
    [Index(nameof(BranchNo), Name = "IX_ONDEMAND_LOAN_BranchNo")]
    [Index(nameof(DataDate), Name = "IX_ONDEMAND_LOAN_DataDate")]
    [Index(nameof(RefNo), Name = "IX_ONDEMAND_LOAN_Ref")]
    [Index(nameof(Updatedate), Name = "IX_ONDEMAND_LOAN_UpdateTime")]
    [Index(nameof(BatchNumber), Name = "NCI_EUC_ONDM_ONDEMAND_LOAN_BATCH_NUMBER")]
    [Index(nameof(BatchNumber), Name = "NCI_EUC_ONDM_ONDEMAND_LOAN_BATCH_NUMBER2")]
    public partial class OndemandLoan
    {
