...
{
    [Keyless]
    [Table("LOAN_TRANCHE_MASTER_BATCH")]
    [Index(nameof(BatchNumber), Name = "NCI_LOAN_TRANCHE_MASTER_BATCH_COVERING")]
    [Index(nameof(BatchNumber), Name = "idx_LOAN_TRANCHE_MASTER_BATCH_Batch_Number")]
    public partial class LoanTrancheMasterBatch
    {
        [Column("TRANCHE_NO")]
