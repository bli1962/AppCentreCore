...
{
    [Table("SETTLEMENT_CORP_CUST_DEFAULT", Schema = "dbo")]
    [Index("BranchNo", "RecordKind", "CcyAbbr", "RecSettlCode", "DefaultFlg", Name = "IX_SETTLEMENT_CORP_CUST_DEFAULT", IsUnique = true)]
