...
{
    [Table("DomesticClearing_MultiPurposeInstructionDetail", Schema = "dbo")]
    public partial class DomesticClearingMultiPurposeInstructionDetail
    {
        ...
        [InverseProperty("DomesticClearingMultiPurposeInstructionDetails")]
        public virtual DomesticClearingPayment Payment { get; set; }
        [InverseProperty("MultiPurposeInstructionDetail")]
