...
{
    [Table("PaymentControl_MatchMoneyMarket", Schema = "dbo")]
    [Index("Processed", Name = "NCI_PaymentControl_MatchMoneyMarket_Processed")]
    public partial class PaymentControlMatchMoneyMarket
    {
        ...
        [InverseProperty("PaymentControlMatchMoneyMarkets")]
