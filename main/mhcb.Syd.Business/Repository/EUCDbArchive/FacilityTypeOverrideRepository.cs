...
namespace mhcb.Syd.Business.Repository
{
    public class FacilityTypeOverrideRepository : IFacilityTypeOverride
    {
        ...
        public IEnumerable<FacilityTypeOverride> GetFacilityTypeOverride()
        {
            var entry = (from b in appDbContext.FacilityTypeOverrides
                         orderby b.RefNo
                         select new FacilityTypeOverride()
                         {
                             Id = b.Id,
                             RefNo = b.RefNo,
        ...
        public string InsertFacilityType(InputFacilityType status)
        {
            try
            {
