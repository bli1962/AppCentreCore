...
namespace mhcb.Syd.Business.Repository
{
	public class UserRepository : IUser
	{
        ...
        public IEnumerable<UserView> LoadGuidePasswordByUserId(string userId)
        {
            var entry = (from b in appDbContext.Users
                            .Where(e => e.UserId == userId)
                         select new UserView()
                         {
                             ...
                             GBASE_PWD_BU_STATUS_CODE = b.GbasePwdBuStatusCode,
                             PWD_CREATE_DATE = b.PwdCreateDate,
                             PASSWORD = Krypting.Decrypt(b.Password)  //b.Password
                         })
                         .ToList()
                         .FirstOrDefault();
        ...
        public string UpdateStatus(InputGuideUser status)
		{
			try
			{
                ...
                if (entry != null)
                {
                    ...
                    var v13 = entry.Password;
                    var v14 = entry.RacfPreviousPwd;
                    ...
                    // fix racf password out of date
                    if (Krypting.Decrypt(v13) != Krypting.Decrypt(v14))
                    {
                        AuditLog auditLog = new()
                        {
                            UserId = status.UserId,
                            ...
                            RefNo = status.UserId,
                            TransNo = "",
                            AuditDesc = "Align RACF Pwasword with GUIDE",
                            AppName = "GUIDE",
                            TableName = "Users",
                            OriginalValue = "Previous RACF PW: " + Krypting.Decrypt(v14),
                            NewValue = Krypting.Decrypt(v13),
                        };
                        entry.RacfPreviousPwd = v13;
                        appDbContext.AuditLogs.Add(auditLog);
                    }
