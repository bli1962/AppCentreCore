...
namespace mhcb.Syd.Business.Repository
{
    public class DomesticClearingRepository : IDomesticClearing
    {
        ...
        public IEnumerable<DomesticClearingPaymentView> GetDomesticClearingPaymentByDate(string optDate, string dateType)
        {
            DateTime date = DateTime.Parse(optDate);
    
            List<DomesticClearingPaymentView> entry = new List<DomesticClearingPaymentView>();
            entry = (from b in appDbContext.DomesticClearingPayments
                        .Where(e =>
                        ...
                        .OrderByDescending(e => e.PaymentId)
                         select new DomesticClearingPaymentView()
                           {
                               PaymentId = b.PaymentId,
                               ValueDate = (DateTime)b.ValueDate,
                               TotalAmount = b.TotalAmount?? 0,
                               CurrencyCode = b.CurrencyCode,
                               CustomerCurrentAccount = b.CustomerCurrentAccount,
                               CustomerAbbreviation = b.CustomerAbbreviation,
                               AccountName = b.AccountName,
                               StatusId = b.StatusId,
                               ProcessDate = (DateTime)b.ProcessDate ,
                               UpdatedWhen = (DateTime)b.UpdatedWhen,
                               UpdatedWho = b.UpdatedWho,
                               CreatedWhen = (DateTime)b.CreatedWhen
                           })
                        .ToList(); 
            return entry;
        }
