        ...
        public IEnumerable<CovenantRatioView> GetCovenantRatio(string covenantType, string dateType, string strDateFrom, string strDateTo)
        {
            ...
            var entry = (from cm in appDbContext.CovenantMasters
                         ...
                         select new CovenantRatioView()
                         {
                             ...
                             COV_START_DATE = (DateTime)cm.CovStartDate,
                             COV_END_DATE = (DateTime)cm.CovEndDate,

                             DATE_RECIEVED_ADJ = (DateTime)cr.DateRecievedAdj,
                             DATE_RECIEVED = (DateTime)cr.DateRecieved,

                             REPORT_DATE = (DateTime)cr.ReportDate,
                             DUE_DATE = (DateTime)cr.DueDate,
