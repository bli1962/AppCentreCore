...
namespace mhcb.Syd.Api.Controllers
{
    ...
    public class DomesticClearingsController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<DomesticClearingPaymentView> GEtDomesticClearingPaymentByDate(string dateValue, string dateType)
        {
            try
            {
        ...
        //[BasicAuthentication]
        [Authorize]
        [Authorize(Roles = "Domestic Clearing Au,Administrator")]
        [Route("")]
        [HttpPut]
