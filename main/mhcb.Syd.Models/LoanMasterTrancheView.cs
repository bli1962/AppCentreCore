...
namespace mhcb.Syd.Models
{
    public class LoanMasterTrancheView
    {
        ...
        public Nullable<DateTime> AGREEM_DATE1 { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> AGREEM_DATE2 { get; set; }
        ...
        //public DateTime PROC_ON { get; set; }
        //public string APPR_BY { get; set; }
        //public DateTime APPR_ON { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> APPLN_DATE { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> HO_APPR_DATE { get; set; }
        public string APPLN_NO_RELT { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> APPLN_DATE_RELT { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> AVAIL_START { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> AVAIL_END { get; set; }
        public string PERIOD_NOTES { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> MAT_DATE { get; set; }
