...
namespace mhcb.Syd.Models
{
    public class FacilityMasterLoanTransView
    {
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public DateTime APPR_DATE1 { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public DateTime SIGHT_DATE { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public DateTime FEE_START_DATE { get; set; }

        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public DateTime FEE_END_DATE { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public DateTime FEE_COL_DATE { get; set; }
        ...
        public decimal DRAW_AMT { get; set; }
        ...
        public decimal REPAY_AMT { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> FINAL_DUE_DATE { get; set; }

        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> INTEREST_TO_DATE { get; set; }
        ...
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> InitialInputDateTime { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> InitialApprovalDateTime { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> FinalApprovalDateTime { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> ModifyRateDateTime { get; set; }
        [DisplayFormat(DataFormatString = ("{dd/MM/yyyy}"))]
        public Nullable<DateTime> ApproveModifiedRateDateTime { get; set; }
