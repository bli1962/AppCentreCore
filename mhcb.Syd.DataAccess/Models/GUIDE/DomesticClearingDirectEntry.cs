...
{
    [Table("DomesticClearing_DirectEntry")]
    public partial class DomesticClearingDirectEntry
    {
        ...
        [InverseProperty(nameof(DomesticClearingPayment.DomesticClearingDirectEntries))]
        public virtual DomesticClearingPayment Payment { get; set; }
        [ForeignKey(nameof(PaymentLineId))]
        [InverseProperty(nameof(DomesticClearingPaymentLine.DomesticClearingDirectEntries))]
