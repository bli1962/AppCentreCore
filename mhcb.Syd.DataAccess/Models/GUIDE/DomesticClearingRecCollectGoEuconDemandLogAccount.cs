...
{
    [Table("DomesticClearing_Rec_Collect_GO_EUCOnDemandLogAccount")]
    public partial class DomesticClearingRecCollectGoEuconDemandLogAccount
    {
        [Key]
        [Column("RecCollectGOEUCOnDemandLogAccountId")]
        public int RecCollectGoeuconDemandLogAccountId { get; set; }
        ...
        [InverseProperty(nameof(DomesticClearingRecCollection.DomesticClearingRecCollectGoEuconDemandLogAccounts))]
