...
{
    [Table("DomesticClearing_Rec_Collect_GO_EUCOnDemandLogCommon")]
    public partial class DomesticClearingRecCollectGoEuconDemandLogCommon
    {
        [Key]
        [Column("RecCollectGOEUCOnDemandLogCommonId")]
        public int RecCollectGoeuconDemandLogCommonId { get; set; }
        ...
        [InverseProperty(nameof(DomesticClearingRecCollection.DomesticClearingRecCollectGoEuconDemandLogCommons))]
