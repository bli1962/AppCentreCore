...
{
    [Table("GAS_GO_DEBIT")]
    [Index(nameof(MinNo), Name = "GasGoDebit_MinNo", IsUnique = true)]
    public partial class GasGoDebit
    {
        public GasGoDebit()
        {
        ...
        [InverseProperty(nameof(DomesticClearingGoposting.DebitMinNoNavigation))]
