...
{
    [Table("DomesticClearing_Rec_Collect_Payment_MultiPurposeInstructionDetail")]
    public partial class DomesticClearingRecCollectPaymentMultiPurposeInstructionDetail
    {
        [Key]
        public int RecCollectPaymentMultiPurposeInstructionDetailId { get; set; }
        ...
        [InverseProperty(nameof(DomesticClearingRecCollection.DomesticClearingRecCollectPaymentMultiPurposeInstructionDetails))]
