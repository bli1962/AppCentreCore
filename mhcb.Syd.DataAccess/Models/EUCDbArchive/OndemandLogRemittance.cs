...
{
    [Keyless]
    [Table("ONDEMAND_LOG_REMITTANCE", Schema = "EUC_ONDM")]
    public partial class OndemandLogRemittance
    {
        ...
        [Column("ACT_VALUE_DATE", TypeName = "datetime")]
        public DateTime? ActValueDate { get; set; }
        [Column("FWD_VALUE_FLG")]
        [StringLength(1)]
        public string FwdValueFlg { get; set; }
        [Column("CUST_ABBR")]
        [StringLength(12)]
        ...
        [Column("TAG33_AMOUNT", TypeName = "decimal(19, 3)")]
        ...
        [Column("TAG34_AMOUNT", TypeName = "decimal(19, 3)")]
        ...
        [Column("ORG_CCY_CD")]
        [StringLength(2)]
        public string OrgCcyCd { get; set; }
        [Column("ORG_AMOUNT", TypeName = "decimal(19, 3)")]
        public decimal? OrgAmount { get; set; }
        [Column("SETTLE_CD")]
        [StringLength(2)]
        public string SettleCd { get; set; }
        [Column("PO_VALUE_DATE", TypeName = "datetime")]
        ...
        [Column("TAG71F_SE_CHG_AMT1", TypeName = "decimal(19, 3)")]
        ...
        [Column("TAG71F_SE_CHG_AMT2", TypeName = "decimal(19, 3)")]
        ...
        [Column("TAG71F_SE_CHG_AMT3", TypeName = "decimal(19, 3)")]
        ...
        [Column("TAG71F_SE_CHG_AMT4", TypeName = "decimal(19, 3)")]
        ...
        [Column("TAG71G_REC_CHG_AMT", TypeName = "decimal(19, 3)")]
        ...
        [Column("BENECUST_ID")]
        [StringLength(12)]
        public string BenecustId { get; set; }
        [Column("BENECUST_ACT")]
        [StringLength(35)]
        public string BenecustAct { get; set; }
        [Column("BENECUST_NAME1")]
        [StringLength(35)]
        public string BenecustName1 { get; set; }
        [Column("BENECUST_NAME2")]
        [StringLength(35)]
        public string BenecustName2 { get; set; }
        [Column("BENECUST_NAME3")]
        [StringLength(35)]
        public string BenecustName3 { get; set; }
        [Column("BENECUST_NAME4")]
        [StringLength(35)]
        public string BenecustName4 { get; set; }
        [Column("CRT_DATE")]
        [StringLength(19)]
