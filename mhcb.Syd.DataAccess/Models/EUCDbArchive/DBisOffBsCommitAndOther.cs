...
{
    [Keyless]
    [Table("D_BIS_OFF_BS_COMMIT_AND_OTHERS", Schema = "EUC")]
    public partial class DBisOffBsCommitAndOther
    {
        ...
        [Column("PARTCIPANT_SUB_NO")]
        [StringLength(2)]
        public string PartcipantSubNo { get; set; }
        [Column("DD_NO")]
        [StringLength(3)]
        ...
        [Column("BALANCE_PRIME_CCY", TypeName = "decimal(18, 3)")]
        public decimal? BalancePrimeCcy { get; set; }
        ...
        [Column("CREDIT_RISK", TypeName = "decimal(3, 0)")]
        public decimal? CreditRisk { get; set; }
        [Column("CREDIT_RISK_EQUIV", TypeName = "decimal(18, 3)")]
        public decimal? CreditRiskEquiv { get; set; }
