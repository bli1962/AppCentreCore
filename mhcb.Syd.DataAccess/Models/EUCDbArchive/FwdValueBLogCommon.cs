...
{
    [Keyless]
    [Table("FWD_VALUE_B_LOG_COMMON", Schema = "EUC")]
    public partial class FwdValueBLogCommon
    {
        ...
        [Column("FWD_PROC_FLG")]
        [StringLength(1)]
        public string FwdProcFlg { get; set; }
        [Column("VALDT_TRANS_NO")]
        [StringLength(5)]
        public string ValdtTransNo { get; set; }
        [Column("FWD_DELETE_FLG")]
        [StringLength(1)]
        public string FwdDeleteFlg { get; set; }
        [Column("IBF_ID")]
        [StringLength(1)]
        ...
        [Column("IMP_EMP_CD")]
        [StringLength(4)]
        public string ImpEmpCd { get; set; }
        [Column("IMP_OPE_ID")]
        [StringLength(3)]
        public string ImpOpeId { get; set; }
        ...
        [Column("INT_FEE_CD")]
        [StringLength(1)]
        public string IntFeeCd { get; set; }
        [Column("TRANS_TIME")]
        [StringLength(6)]
