...
{
    [Keyless]
    [Table("ONDEMAND_GUARANTEE", Schema = "EUC_ONDM")]
    [Index(nameof(BatchNumber), Name = "NCI_EUC_ONDM_ONDEMAND_GUARANTEE_BATCH_NUMBER")]
    public partial class OndemandGuarantee
    {
