...
{
    [Keyless]
    [Table("BIS_OFF_BS_CURRENT_EXPOSURE", Schema = "EUC")]
    public partial class BisOffBsCurrentExposure
    {
        ...
        [Column("CORRENT_EXP_TYPE")]
        [StringLength(1)]
        public string CorrentExpType { get; set; }
        [Column("DEPT_CD")]
        [StringLength(2)]
        ...
        [Column("NOTIONAL_IN_FC", TypeName = "decimal(18, 3)")]
        public decimal? NotionalInFc { get; set; }
        [Column("NOTIONAL_IN_BC", TypeName = "decimal(18, 3)")]
        public decimal? NotionalInBc { get; set; }
        ...
        [Column("CURRENT_REPLACEMENT", TypeName = "decimal(18, 3)")]
        public decimal? CurrentReplacement { get; set; }
        [Column("ACR_BIS_NO")]
        [StringLength(3)]
        ...
        [Column("ACM_COM_RISK_AST", TypeName = "decimal(18, 3)")]
        public decimal? AcmComRiskAst { get; set; }
