...
{
    public class GetSwapRfrInterestBase : ComponentBase
    {
        [Inject]
        ...
        public IEnumerable<RFRInterestSwapView> modelView { get; set; } = new List<RFRInterestSwapView>();
        ...
        protected async Task SearchClick()
        {
            ...
            modelView = null;
            modelView = (await _httpService.GetRFRInterestForSwapByReportDate(
