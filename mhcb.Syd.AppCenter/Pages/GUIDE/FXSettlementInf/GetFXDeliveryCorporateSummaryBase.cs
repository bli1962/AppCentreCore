...
{
    public class GetFXDeliveryCorporateSummaryBase : ComponentBase
    {
        [Inject]
        ...
        public IEnumerable<FxDeliveryCorpSummaryView> modelView { get; set; } = new List<FxDeliveryCorpSummaryView>();
        ...
        {
            modelView = null;
            modelView = (await _httpService.GetFxDeliveryCorpSummaryByDate(
