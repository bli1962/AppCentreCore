...
{
    public class GetSettlementInfByIdBase : ComponentBase
    {
        [Inject]
        ...
        //public string SelectedSifId { get; set; } = "";
        protected SIFSearchModel searchModel = new()
        {
            SifID = ""
        };
        ...
        {
            //if ((searchModel.SifID == "")) return;

            settlementInfView = null;
            settlementInfView = (await _httpService.GetSIFById(Int32.Parse(searchModel.SifID))).ToList(); 
