...
{
    public class GetSIFInstructionsByStatusBase : ComponentBase
    {
        [Inject]
        ...
        public string SelectedStatus { get; set; } = "S";
        ...
        protected async Task SearchClick()
        {
            ...
            settlementInfView = (await _httpService.GetSifInstructionsByStatus(SelectedStatus)).ToList();
